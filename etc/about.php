...
<html lang="en">
  <head>
    ...
    <title>เกี่ยวกับเรา | T-Shirt</title>
  ...
  <body>
    ...
    <div style="padding-top:30px;padding-bottom:30px;background-color: #eee;">
      <div class="container">
        <h2><strong style="color:#888">About Me</strong></h2><br>
        <p style="color:#888">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ผมได้ทำเว็บนี้ขึ้นมา มิได้นำไปเพื่อผลประโชยน์ทางด้านรายได้แต่อย่างใด ถ้าผิดพลาดประการใดกระผมขออภัยมา ณ ที่นี้ด้วย</p>
        <br>
