...
<html lang="en">
  <head>
    ...
    <title>สินค้าใหม่ | T-Shirt</title>
  ...
  <body>
    ...
    <div class="list">
      <div class="container">
        <ol class="breadcrumb" style="padding-top:100px;">
          ...
          <li class="active">สินค้าลดราคา</li>
        </ol>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <?php
         ...
         $strSQL = "select * from products where product_tag='sale' limit {$start} , {$perpage}";
        ...
        ?>
              ...
              <div class="col-xs-12 col-sm-3" style="text-align:center">
                 <a href="detailproduct.php?id=<?php echo $result['product_id'];?>">
               ...
               <?php
                ...
                ?>
        <?php
           $sql2 = "select * from products where product_tag='sale'";
