...
<html lang="en">
  <head>
    ...
    <title>เข้าสู่ระบบ | T-Shirt</title>
    ...
    <div style="padding-top:120px;padding-bottom:60px;background-color: #fff;">
      <div class="container">
        <div class="title">
          <?php
          if($_GET['regis']=='yes'){
          echo '<div class="alert alert-success" role="alert">เสร็จสิ้น! คุณได้สมัครสมาชิกเรียบร้อยแล้ว.</div>';
          }
          else if($_GET['login']=='fail'){
            echo '<div class="alert alert-danger" role="alert">ผิดพลาด! คุณได้กรอกอีเมล์หรือรหัสผ่านผิด กรุณาลองใหม่</div>';
          }
          ?>
          <h2 class="filter-title" style="text-align:left">
            <span class="content" style="font-size:16px;letter-spacing:1px;background-color: #fff;padding: 20px;display: inline;"><strong>เข้าสู่ระบบ หรือ สมัครสมาชิก</strong></span>
          </h2><br><br>
          <div class="col-md-6" >
            <h4>ลูกค้าใหม่</h4><br>
            <p>การสมัครสมาชิก ช่วยให้คุณสามารถทำการสั่งซื้อได้เร็วขึ้น ไม่ต้องกรอกที่อยู่ใหม่อีกครั้งเมื่อสั่งซื้อครั้งต่อไป และ สามารถติดตามสถานะคำสั่งซื้อได้ตลอดเวลา</p><br><br><br><br><br><br>
            <a href="register.php"><button type="submit" class="btn btn-default pull-right">สมัครสมาชิก</button></a>
          </div>
          <div class="col-md-6" >
            <h4>ลูกค้าที่ลงทะเบียนแล้ว</h4><br>
            <p>ถ้าคุณเคยสมัครสมาชิกกับเราแล้ว กรุณาเข้าสู่ระบบ</p>
            <form action="checkmember.php" method="post">
              ...
              <div class="form-group">
                <a href="#" class="pull-left">ลืมรหัสผ่าน</a>
