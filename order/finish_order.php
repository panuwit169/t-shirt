        ...
        <div class="container">
          <div class="title">
            <h2 class="filter-title" style="text-align:left">
              <span class="content" style="font-size:16px;letter-spacing:1px;background-color: #fff;padding: 20px;display: inline;"><strong>เราได้รับคำสั่งซื้อของคุณแล้ว</strong></span>
            </h2>
            <br>
          </div>
          <strong>ขอบคุณที่ซื้อสินค้ากับเรา!</strong><br><br>
          <p>เลขที่คำสั่งซื้อของคุณ คือ: <a href="view_order.php?OrderID=<?php echo $_GET["OrderID"];?>"><?php echo $_GET["OrderID"];?></a></p>
          <p>คลิก <a href="#">ที่นี่ เพื่อพิมพ์</a> สำเนาคำสั่งซื้อของคุณ</p><br>
          <a href="../payment/confirm-payment.php"><button class="btn btn-default pull-left">แจ้งการชำระเงิน</button></a><a href="../index.php"><button class="btn btn-default pull-right">กลับสู่หน้าหลัก</button></a>
