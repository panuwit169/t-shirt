...
<html lang="en">
  ...
  <body>
    ...
    <div style="padding-top:20px;padding-bottom:60px;background-color: #fff;">
      <div class="container">
        <?php
        if($_GET['success']=='yes'){
        echo '<div class="alert alert-success" role="alert">เสร็จสิ้น! คุณได้แจ้งการชำระเงินเรียบร้อยแล้ว.</div>';
        }
        else if($_GET['success']=='fail'){
          echo '<div class="alert alert-danger" role="alert">ผิดพลาด! คุณได้แจ้งการชำระเงินผิดผลาด กรุณาลองใหม่</div>';
        }
        ?>
        <div class="title">
          <h2 class="filter-title" style="text-align:left">
            <span class="content" style="font-size:16px;letter-spacing:1px;background-color: #fff;padding: 20px;display: inline;"><strong>แจ้งการชำระเงิน</strong></span>
          </h2><br>
          <form action="save-confirm-payment.php" method="post" enctype="multipart/form-data">
            <div class="col-xs-12 col-md-6">
                <label for="name">ชื่อ</label>
                <input type="text" class="form-control" id="name" name="name" required maxlength="30">
            </div>
            <div class="col-xs-12 col-md-6" style="padding-bottom:10px">
              <label for="lname">นามสกุล</label>
              <input type="text" class="form-control" id="lname" name="lname" required maxlength="30">
            </div>
            <div class="col-xs-12 col-md-6" style="padding-bottom:10px">
              <label for="tel">เบอร์โทร</label>
              <input type="text" class="form-control" id="tel" name="tel" required maxlength="15">
            </div>
            <div class="col-xs-12 col-md-6" style="padding-bottom:10px">
              <label for="order_id">เลขที่ใบสั่งซื้อ</label>
              <input type="text" class="form-control" id="order_id" name="order_id" required maxlength="30">
            </div>
            <div class="col-xs-12 col-md-6" >
            ...
            <div class="col-xs-12 col-md-6" >
                <label for="files">แนบหลักฐาน (อาทิเช่น ใบเสร็จการโอนเงิน เป็นต้น)</label>
            ...
            <div class="col-xs-12 col-md-12" style="padding-top:10px">
                <input type="submit" class="btn btn-default pull-right" value="ยืนยันแจ้งการชำระเงิน">
            </div>
        </form>
        </div>
